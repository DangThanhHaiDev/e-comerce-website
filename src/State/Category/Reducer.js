...
export const categoryReducer = (state = initialState, action) => {
    switch (action.type) {
        case GET_CATEGORIES_LEVEL3_REQUEST:
        ...
        case GET_CATEGORIES_LEVEL3_SUCCESS:
            return { ...state, isLoading: false, category3: action.payload }
        case GET_CATEGORIES_LEVEL3_FAILURE:
